...
type LoadBalancerM struct {
    discovery.GraphBuilderCentralized
}


func (r LoadBalancerM) Rcv(msg bh.Msg, ctx bh.RcvContext) error {
...
func (m LoadBalancerM) Map(msg bh.Msg, ctx bh.MapContext) bh.MappedCells {
    switch dm:=msg.Data().(type){
    case InterAreaQuery:
